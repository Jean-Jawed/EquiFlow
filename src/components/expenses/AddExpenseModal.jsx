...
const AddExpenseModal = ({ onClose, groupId, participants, currency }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (title.length > 100) {
      showToast('Le titre ne peut pas dépasser 100 caractères', 'error');
      return;
    }
  ...
  return (
    <Modal onClose={onClose} title="Ajouter une dépense">
